...
void (CODEGEN_FUNCPTR *_ptrc_glDebugMessageCallbackAMD)(GLDEBUGPROCAMD callback, void * userParam) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glDebugMessageEnableAMD)(GLenum category, GLenum severity, GLsizei count, const GLuint * ids, GLboolean enabled) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glDebugMessageInsertAMD)(GLenum category, GLenum severity, GLuint id, GLsizei length, const GLchar * buf) = NULL;
GLuint (CODEGEN_FUNCPTR *_ptrc_glGetDebugMessageLogAMD)(GLuint count, GLsizei bufsize, GLenum * categories, GLuint * severities, GLuint * ids, GLsizei * lengths, GLchar * message) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glTexturePageCommitmentEXT)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLboolean resident) = NULL;
...
static ogl_StrToExtMap ExtensionMap[18] = {
