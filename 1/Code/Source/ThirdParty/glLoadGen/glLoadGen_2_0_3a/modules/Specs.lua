...
---FilePrefix (**changed**)
function gl_spec.FilePrefix() return "gl" end
function wgl_spec.FilePrefix() return "wgl" end
function glx_spec.FilePrefix() return "glx" end
...
for key, spec in pairs(specTbl) do
	for _, props in ipairs(fileProps) do
		spec[props[1]] = function()
			return dofile(util.GetDataFilePath() .. spec:FilePrefix() .. "_" .. -- (**changed**)
				"spec" .. props[2] .. ".lua")
		end
	end
end
